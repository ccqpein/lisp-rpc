...
impl<'a> SerializeSeq for &'a mut LispRPCMapSerializer {
    type Ok = ();
...
impl<'a> SerializeTuple for &'a mut LispRPCMapSerializer {
    type Ok = ();
...
impl<'a> SerializeTupleStruct for &'a mut LispRPCMapSerializer {
    type Ok = ();
...
impl<'a> SerializeMap for &'a mut LispRPCMapSerializer {
    type Ok = ();
...
impl<'a> SerializeTupleVariant for &'a mut LispRPCMapSerializer {
    type Ok = ();
...
impl<'a> SerializeStructVariant for &'a mut LispRPCMapSerializer {
    type Ok = ();
...
impl<'a> SerializeStruct for &'a mut LispRPCMapSerializer {
    type Ok = ();
...
/// impl the Serializer, most important one is struct and primary types
impl<'a> Serializer for &'a mut LispRPCMapSerializer {
    type Ok = ();
